...
class Localizacao
{
    ...
    public function salvar($conn)
    {
        ...
        $stmt->bind_param("sssssssssiiii", $this->provincia, $this->distrito, $this->bairro, $this->posto_administrativo, $this->localidade, $this->avenida, $this->rua, $this->andar, $this->endereco_detalhado, $this->codigo_postal, $this->latitude, $this->longitude, $this->referencia);
